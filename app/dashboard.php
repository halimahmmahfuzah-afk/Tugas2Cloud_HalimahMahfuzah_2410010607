    ...
    <div class="container mt-4">
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-success shadow-sm" role="alert">
                    ...
                    <p class="mb-0">Anda login sebagai <strong>Masyarakat</strong>. Anda dapat menulis pengaduan baru atau melihat status pengaduan Anda di bawah ini.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                <h5 class="mb-0">Daftar Laporan Terbaru</h5><?php if ($_SESSION['role'] == 'masyarakat') { ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover align-middle">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            // Menampilkan data pengaduan digabung dengan nama pelapor
                            $query = mysqli_query($koneksi,"SELECT tb_pengaduan.*, tb_user.nama_lengkap FROM tb_pengaduan INNER JOIN tb_user ON tb_pengaduan.id_user = tb_user.id_user ORDER BY id_pengaduan DESC");
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($_SESSION['role'] == 'admin') { ?>
                                        ...
                                        <a href="hapus_pengaduan.php?id=<?php echo $row['id_pengaduan']; ?>"class="btn btn-danger btn-sm mt-1" onclick="return confirm('Yakin ingin menghapus laporan ini?')">Hapus</a>
